...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_src", type=str, default="weight/target/")
    ...
    for i in range(len(names)):
        ...
        folder = "/scratch/qz2208/AaD_SFDA/dataset/"
        args.s_dset_path = folder + args.dset + "/train/" + names[args.s] + "_list.txt"
